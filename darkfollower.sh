...
read -p $'  \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m nome de usuário: \e[0m' user
fi

if [[ -e cookie.$user ]]; then

printf "  \e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m informações salvas do usuário encontrada \e[0m\e[1;77m %s\e[0m\n" $user

default_use_cookie="Y"

read -p $'  \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m deseja usá-las?\e[0m\e[1;77m [Y/n]\e[0m ' use_cookie

use_cookie="${use_cookie:-${default_use_cookie}}"

if [[ $use_cookie == *'Y'* || $use_cookie == *'y'* ]]; then
printf "  \e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Usando informações salvas\e[0m\n"
else
rm -rf cookie.$user
login_user
fi
...
printf "  \e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Tentando se conectar...\e[0m\e[1;93m %s\e[0m\n" $user
IFS=$'\n'
...
printf "\n"
printf "  \e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] By Lzz \e[0m\n"
printf "  \e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] esse processo pode demorar um pouco...\e[0m\n"
...
if [[ ! -e celeb_id ]]; then
printf " %s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n" $dualipa $celebrity $mileycyrus $shawnmendes $katyperry $charlieputh $lelepons $camila_cabello $madonna $leonardodicaprio $ladygaga $taylorswift $instagram $neymar $selena $ariana $beyonce $cristiano $kimkardashian $kendall $therock $kylie $jelopez $messi > celeb_id
fi
...
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Tentando seguir %s ..." $celeb
...
printf " \n\e[1;31m [!] Erro\n"
printf " \n\e[1;33m [::] Encontrei um erro na sua conta do Instagram \n"
printf " \n\e[1;31m [:] problema encontrado:\n"
printf " \n\e[1;33m - você atingiu o limite de seguimentos do Instagram \n."
printf " \n\e[1;33m - sua conta foi temporariamente banida\n"
printf " \n\e[1;32m [:] Solução\n"
printf " \n\e[1;33m - fique sem mexer na sua conta do Instagram por 24 horas e depois tente executar o script novamente \n"
...
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m tentando deixar de seguir %s ..." $celeb
...
printf "\n \e[1;93m [!] erro, parado para evitar bloqueamento\n"
printf " \e[1;33m [-] você ja tentou muito por hoje, tente novamente outro dia.\n"
...
printf "\n"
printf " \e[1;31m[\e[0m\e[1;77m01\e[0m\e[1;31m]\e[0m\e[1;93m ganhar seguidores\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m02\e[0m\e[1;31m]\e[0m\e[1;93m sair\e[0m\n"
printf "\n"
...
printf "\n"
printf "  \e[1;91mfé cria !!\e[0m\n"
printf "\n"
exit

else

printf " \e[1;93m[!] opção invalida!\e[0m\n"
sleep 2
menu
